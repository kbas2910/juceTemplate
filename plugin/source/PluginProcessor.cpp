...
void MainProcessor::changeProgramName(int index,
                                                  const juce::String& newName)
{
  juce::ignoreUnused(index, newName);
}

void MainProcessor::prepareToPlay(double sampleRate,
                                              int samplesPerBlock)
{
...
bool MainProcessor::isBusesLayoutSupported(
...
void MainProcessor::getStateInformation(
...
void MainProcessor::setStateInformation(const void* data,
                                                    int sizeInBytes)
{
